...
const partners = {
  row1: [
    ...
    { name: "Liberty", localLogo: "/logos/liberty.svg" },
    { name: "Mapfre", localLogo: "/logos/mapfre.svg" },
    { name: "HDI", localLogo: "/logos/hdi.svg" },
    { name: "Arch", localLogo: "/logos/arch.svg" },
  ],
  row2: [
    ...
    { name: "Berkley", localLogo: "/logos/berkley.svg" },
    { name: "Sompo", localLogo: "/logos/sompo.png" },
    { name: "Fairfax", localLogo: "/logos/fairfax.svg" },
    { name: "Travelers", localLogo: "/logos/travelers.svg" },
  ],
  row3: [
    ...
    { name: "Markel", localLogo: "/logos/markel.svg" },
    { name: "Beazley", localLogo: "/logos/beazley.svg" },
    { name: "Hiscox", localLogo: "/logos/hiscox.svg" },
    { name: "Akad", localLogo: "/logos/akad.svg" },
  ],
};
