...
export function HubSpotContactSection({
          ...
          if (window.hbspt) {
            try {
              ...
              window.hbspt.forms.create({
                region: "na1",
                portalId: "50300049",
                formId: "85e09a8c-09fc-476b-86d6-249a2c2ec4ed",
  ...
  return (
    <>
      ...
      <section ref={sectionRef} id="contato" className="py-20 bg-gradient-to-r from-[#011633] to-[#121929] text-white">
          ...
          <div className="max-w-6xl mx-auto mt-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className={`rounded-2xl overflow-hidden relative transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
                <Image
                  src="https://i.ibb.co/fdQCHTnM/c7bf7e18-a680-445f-acff-3f452bd24fe4.png"
                  alt="Contact Forters via WhatsApp"
                  width={600}
                  height={500}
              ...
              <div className="space-y-8">
                ...
                <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  ...
                  <DialogContent className="fixed inset-0 w-screen h-screen max-w-none max-h-none rounded-none border-none lg:inset-auto lg:w-[1200px] lg:max-w-[90vw] lg:h-auto lg:max-h-[90vh] lg:top-[50%] lg:left-[50%] lg:-translate-x-1/2 lg:-translate-y-1/2 lg:rounded-lg lg:border overflow-y-auto p-0 gap-0 bg-white">
